    ...
    public static function nbTicketsGeneric(
        ...
        switch ($case) {
            ...
            case 'waiting_validation':
                ...
                $params['label'] = __("Jobs waiting for approval");
                $search_criteria = [
                    [
                        'field'      => 55,
                        'searchtype' => 'equals',
