...
final class DefaultDataManager
{
    ...
    public function initializeData(): void
    {
        ...
        $this->tiles_manager->addTile($root_entity, GlpiPageTile::class, [
            'title'        => __("Create a job"),
            'description'  => __("Go to our service catalog and pick a form to create a new job."),
            'illustration' => "request-support",
            'page'         => GlpiPageTile::PAGE_SERVICE_CATALOG,
        ]);

        $this->tiles_manager->addTile($root_entity, GlpiPageTile::class, [
            'title'        => __("See your jobs"),
            'description'  => __("View all the jobs that you have created."),
